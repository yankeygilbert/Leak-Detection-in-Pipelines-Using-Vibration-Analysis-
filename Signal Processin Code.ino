...
SoftwareSerial arduinoSerial(5,6); // tx ,rx
...
void loop() {
 ...
 for( int z = 0; z<= 63; z++)
  {  
    reading_array[z] = a.acceleration.x ;
//    Serial.println(a.acceleration.x);
//    delay(200);
  } 

FFT(reading_array,64,1000); 
